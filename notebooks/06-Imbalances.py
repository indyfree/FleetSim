...
df1 = pd.read_csv("../logs/stats-20190307-235915.csv", parse_dates=[0], infer_datetime_format=True)
...
df2 = pd.read_csv("../logs/stats-20190307-235516.csv", parse_dates=[0], infer_datetime_format=True)
...
plt.plot(df1.imbalance_kw, label="No rental refuse")
plt.plot(df2.imbalance_kw, label="Rental refuse")
plt.legend()
